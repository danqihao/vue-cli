/*
 * @Author:danqihao
 * @Date: 2018-04-08 17:44:13 
 * @Last Modified by: danqihao
 * @Last Modified time: 2018-04-12 17:17:12
 */
    ...
    <el-row  class="toolbar">
        ...
        <el-col :span="3" > 
            <el-select  placeholder="请选择成品型号" size="medium" @change="getBasicInfo()" v-model="req.productModelId">
                ...
                <el-option  v-for="(val,index) in productModel" 
                :value="val.warehouse_product_model_id"
                :key="index" 
                :label="val.warehouse_product_model_name" 
                size="medium">
                </el-option>
            </el-select>
        </el-col>
    ...
    <el-dialog :visible.sync="visible.addForm" :close-on-click-modal="false" width="60%">
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="(value,index) in selectproductList"  :key="index">
							...
							<td>
                                <el-input  size="medium"  placeholder="请输入(必填)" 
                                v-model="selectproductList[index].batch"></el-input>
                            </td>
							<td>
                                <el-input  size="medium"  placeholder="请输入(必填)"  min = 0  type = "number"
                                :value = 'value.num'  @blur="test(value.num,index)" 
                                v-model="selectproductList[index].num"></el-input>
                            </td>
							<td>
                            ...
                            <td>
                                <el-date-picker
                                    v-model="selectproductList[index].data"
                                    type="datetime" 
                        ...
                        <tr v-show="!selectproductList.length"><td colspan=15 class="text-center text-warning">没有可以显示的数据，请重新选择</td></tr>
                    </tbody>
                </table>
            </el-main>
        ...
        <el-container>
            <el-main>
                ...
                <el-row>
                    <el-col class="text-right">
                        <el-pagination @current-change="producthandleCurrentChange" background  layout="total,prev,pager,next" :current-page="productCurrenPage" :page-size="productPagesize" :total=productLines></el-pagination>
                    </el-col>
                </el-row>
            </el-main>
        </el-container>
