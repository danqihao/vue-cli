 ...
 * @Last Modified time: 2018-04-12 17:18:51
 */
<template>
   <section>
                        ...
                        <tbody>
                            <tr v-for="(value,index) in selectMaterialList"  :key="index">
                                ...
                                <td>
                                    ...
                                    :value = 'value.entryNum' @blur="test(value.entryNum,index)"
                                    v-model="selectMaterialList[index].entryNum"></el-input>
                                </td>
                                <td>
                                    <el-input  size="medium"  placeholder="请输入内容(必填)"  type = "number" min = 0 
                                    :value = 'value.checkNum' @blur="test(value.checkNum,index)"
...
<script>
    ...
    import {getWarehouseBasic,queryMaterials,removeMaterialChecks,queryMaterialInventory,saveMaterialChecks} from '../../api/api' 
