/*
 * @Author:danqihao
 * @Date: 2018-04-10 17:44:13 
 * @Last Modified by: danqihao
 * @Last Modified time: 2018-04-12 17:17:26
 */
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="(value,index) in selectproductList"  :key="index">
							...
							<td>{{value.batch}}</td>
							<td>
                                <el-input  size="medium"  placeholder="请输入(必填)"  min = 0  type = "number" :max = 'value.num'
                                :value = 'value.outNum'  @blur="test(value.num,value.outNum,index)" 
