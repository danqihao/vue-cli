/*
 * @Author: danqihao 
 * @Date: 2018-04-09 14:51:51 
 * @Last Modified by: danqihao
 * @Last Modified time: 2018-04-12 17:16:46
 */
<template>
   <section>
                        ...
                        <tbody>
                            <tr v-for="(value,index) in selectMaterialList"  :key="index">
                                ...
                                <td>
                                    ...
                                    @blur="test(value.warehouse_material_batch_number,value.warehouse_material_out_number,index)"
                                    :value = 'value.warehouse_material_out_number'
                                    v-model="selectMaterialList[index].warehouse_material_out_number"></el-input>
                                </td>
                                <td>
                                    <el-input  size="medium"  placeholder="选择车间"  @click.native="selectWorkshop(index)"
                                    :value = 'selectMaterialList[index].work_shop_name'
