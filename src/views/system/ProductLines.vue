  ...
  <el-row style="background-color: transparent">
    ...
    <el-col :span="24">
      ...
      <el-table :data="list" highlight-current-row
        ...
        <el-table-column prop="product_line_code" label="产线代号" sortable></el-table-column>
        <el-table-column prop="product_line_name" label="产线名" sortable></el-table-column>
        <el-table-column prop="product_line_describe" label="说明" sortable></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      postConfig (row) {
        this.$router.push({
          path: '/system/organization/post_config',
          query: {
            type: 'productLineId',
            id: row.product_line_id,
            title: '产线：' + row.product_line_name
          }
        })
      },
      // 人员配置
      staffConfig (row) {
        this.$router.push({
          path: '/system/organization/staff_config',
          query: {
            type: 'productLineId',
            id: row.product_line_id,
            title: '产线：' + row.product_line_name
      ...
      deviceConfig (row) {
        this.$router.push({
          path: '/system/organization/device_config',
          query: {
            type: 'productLineId',
            id: row.product_line_id,
            title: '产线：' + row.product_line_name
      ...
      workshopConfig (row) {
        this.$router.push({
          path: '/system/organization/workshop_config',
          query: {
            type: 'productLineId',
            id: row.product_line_id,
            title: '产线：' + row.product_line_name
