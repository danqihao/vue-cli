...
<template>
  <section>
    ...
    <el-col class="toolbar">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        <el-col :span="20" class="text-right">
          <el-form-item :span="4">
            <el-input v-model.trim="filters.postName" size="medium" placeholder="输入关键字" @keyup.native.enter="getList"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-table :data="posts" highlight-current-row
      ...
      <el-table-column prop="role_post_name" label="姓名" sortable></el-table-column>
    ...
    <el-dialog :visible.sync="visible.addForm" :close-on-click-modal="false">
      ...
      <el-form :model="addForm" label-width="80px" label-position="right" :rules="addFormRules" ref="addForm" class="clearfix">
        <el-col :span="24">
          ...
          <el-form-item label="上级" prop="leaderName">
            <el-autocomplete
              v-model="addForm.leaderName" placeholder="搜索职位"
  ...
  export default {
    ...
    data () {
      return {
        ...
        addFormRules: {
          leaderName: { required: true, message: '上级不能为空', trigger: 'blur' },
          postName: { required: true, message: '职位名称不能为空', trigger: 'blur' },
          detail: { required: true, message: '职位说明不能为空', trigger: 'blur' }
        },
        postId: '-1',
        postName: ''
      }
