...
<template>
  <section>
    ...
    <el-table :data="staffs" highlight-current-row
      ...
      <el-table-column prop="isAssigned" label="是否分配用户" width="" sortable>
        <template slot-scope="scope">
          <el-select v-model="scope.row.isAssigned" placeholder="请选择" @change="handleAssignedChanged(scope.row)">
            <el-option
    ...
    <el-dialog :visible.sync="visible.addForm" :close-on-click-modal="false">
      ...
      <el-form :model="addForm" label-width="80px" label-position="right" :rules="addFormRules" ref="addForm" class="clearfix">
        <el-col :span="12">
          ...
          <el-form-item label="入职日期" prop="employTime">
          ...
          <el-form-item label="生日" prop="staffBirth">
        ...
        <el-col :span="12">
          <el-form-item label="籍贯" prop="staffNative">
          ...
          <el-form-item label="手机" prop="staffTEL">
